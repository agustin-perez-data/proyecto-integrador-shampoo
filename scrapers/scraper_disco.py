...
BASE_URL = "https://www.disco.com.ar/api/catalog_system/pub/products/search/"
OUTPUT = Path(__file__).parent.parent / "data" / "raw" / "disco_raw.csv"
...
def main():
    ...
    print(f"\nProductos únicos Disco: {len(todos)}")
    filas = vtex_a_filas(list(todos.values()), "Disco")
